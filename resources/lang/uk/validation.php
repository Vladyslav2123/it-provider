...
return [
    ...
    'attributes' => [
        ...
        // Сервіси
        'service.title' => 'назва послуги',
        'service.description' => 'опис послуги',
        'service.order' => 'порядок',
        'service.active' => 'активність',
        'newImage' => 'нове зображення',
        'newIcon' => 'нова іконка',

        // Тарифи
        'tariff.name' => 'назва тарифу',
        'tariff.description' => 'опис тарифу',
        'tariff.price' => 'ціна',
        'tariff.speed' => 'швидкість',
        'tariff.period' => 'період',
        'tariff.is_popular' => 'популярний',
        'tariff.active' => 'активний',
        'tariff.order' => 'порядок',

        // Слайдери
        'slider.title' => 'заголовок',
        'slider.description' => 'опис',
        'slider.button_text' => 'текст кнопки',
        'slider.button_url' => 'URL кнопки',
        'slider.order' => 'порядок',
        'slider.active' => 'активний',
        'image' => 'зображення',
